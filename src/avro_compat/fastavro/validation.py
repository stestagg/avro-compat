...
def validate(datum, schema, named_schemas=None, field="", raise_errors=True, strict=False, disable_tuple_notation=False):
...
def validate_many(
    ...
    try:
        sch = schema_.parse_schema(schema, named_schemas=named_schemas, strict=strict, disable_tuple_notation=disable_tuple_notation, invalid_value_includes_record_name=True)
