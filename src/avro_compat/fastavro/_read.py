...
def match_schemas(w_schema, r_schema, named_schemas):
    ...
    w_schema = _get_cschema(parse_schema(w_schema, named_schemas=named_schemas.get('writer', None), defer_schema_promotion_errors=False))
    r_schema = _get_cschema(parse_schema(r_schema, named_schemas=named_schemas.get('reader', None), defer_schema_promotion_errors=False))
