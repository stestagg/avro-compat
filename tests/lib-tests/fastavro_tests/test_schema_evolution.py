from avro_compat.fastavro import writer as fastavro_writer
from avro_compat.fastavro.read import SchemaResolutionError
from avro_compat.fastavro.utils import generate_one
