...
from avro_compat.fastavro.const import MCS_PER_SECOND, MLS_PER_SECOND
from avro_compat.fastavro._logical_writers_py import prepare_timestamp_micros
from avro_compat.fastavro._logical_writers_py import prepare_timestamp_millis
import pytest
