...
try:
    from avro_compat.fastavro._read import match_types, match_schemas
except ImportError:
    from avro_compat.fastavro._read_py import match_types, match_schemas  # type: ignore

from avro_compat.fastavro._read_common import SchemaResolutionError
