...
from avro_compat.fastavro.io.binary_decoder import BinaryDecoder
from avro_compat.fastavro.read import _read as _reader, HEADER_SCHEMA, SchemaResolutionError
from avro_compat.fastavro.write import _write as _writer, Writer
