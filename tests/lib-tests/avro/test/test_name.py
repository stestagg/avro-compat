...
import avro_compat.avro.protocol 
...
class TestName(unittest.TestCase):
    ...
    def test_disable_name_validation(self):
        ...
        # Test name class
        avro.schema.Name(
            name_attr="an especially spacey cowboy", space_attr=None, default_space=None, validate_name=False
        )
        avro.schema.Name(
            name_attr="cowboy", space_attr="an especially spacey ", default_space=None, validate_name=False
        )
        avro.schema.Name(
            name_attr="cowboy", space_attr=None, default_space="an especially spacey ", validate_name=False
        )
        avro.schema.Name(
            name_attr="name-space.with-dash.cowboy", space_attr=None, default_space=None, validate_name=False
        )
        ...
        cowboy_record_1 = avro.schema.RecordSchema(
            name="an especially spacey cowboy",
            namespace=None,
        ...
        cowboy_record_2 = avro.schema.RecordSchema(
            name="cowboy",
            namespace="an especially spacey ",
        ...
        avro.schema.FixedDecimalSchema(
            name="an especially spacey cowboy", namespace=None, size=16, precision=2, validate_names=False
        )
        avro.schema.FixedDecimalSchema(
            name="cowboy", namespace="an especially spacey", size=16, precision=2, validate_names=False
        )

        # Test enum schema
        avro.schema.EnumSchema(
            name="an especially spacey cowboy", namespace=None, symbols=["A", "B"], validate_names=False
        )
        avro.schema.EnumSchema(
            name="cowboy", namespace="an especially spacey", symbols=["A", "B"], validate_names=False
        )
...
class ParseSchemaNameValidationDisabledTestCase(unittest.TestCase):
    ...
    def parse_invalid_name(self) -> None:
        ...
        with self.assertRaises(
            ...
            msg=f"Invalid schema should not have parsed: {self.test_schema_string!s}",
        ):
