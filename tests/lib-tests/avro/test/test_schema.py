    ...
    ValidTestSchema(
        {
            "type": "record",
            "name": "LinkedList",
            "fields": [{"name": "value", "type": "int"}, {"name": "next", "type": ["null", "LinkedList"]}],
        }
    ),
    ValidTestSchema(
        {
    ...
    ValidTestSchema(
        {
            "type": "record",
            "name": "ns.int",
            "fields": [{"name": "value", "type": "int"}, {"name": "next", "type": ["null", "ns.int"]}],
        }
    ),
]
                ...
                "fields": [
                    {
                        ...
                        "type": [
                            ...
                            "string",
                            {
                                "type": "record",
                                "name": "Cons",
                                "fields": [{"name": "car", "type": "Lisp"}, {"name": "cdr", "type": "Lisp"}],
                            },
                        ],
                    }
                ],
...
class TestMisc(unittest.TestCase):
    ...
    def test_parse_invalid_symbol(self):
        ...
        with self.assertRaises(
            ...
            msg="When enum symbol validation is enabled, an invalid symbol should raise InvalidName.",
        ):
