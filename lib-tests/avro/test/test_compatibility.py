...
from avro.compatibility import (  # switch-compat
    ReaderWriterCompatibilityChecker,
    SchemaCompatibilityType,
    SchemaType,
)
from avro.schema import (  # switch-compat
    ArraySchema,
    MapSchema,
    Names,
    PrimitiveSchema,
...
ENUM_AB_ENUM_DEFAULT_A_SCHEMA = parse(
    json.dumps({"type": SchemaType.ENUM, "name": "Enum", "symbols": ["A", "B"], "default": "A"})
)
